...
class AdapterUser2(itensList: MutableList<BaseUser>, context: Context, actions: Actions): Adapter<BaseUser>(itensList, context, actions) {
    private val TAG = javaClass.simpleName
    private val layoutID = R.layout.item_user2 //Id do item layout
    ...
    override fun searchValue(item: BaseUser?): String {
        return item!!.name
    }
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            layout.setOnClickListener(this@AdapterUser2)
            layout.setOnLongClickListener(this@AdapterUser2)
        }
